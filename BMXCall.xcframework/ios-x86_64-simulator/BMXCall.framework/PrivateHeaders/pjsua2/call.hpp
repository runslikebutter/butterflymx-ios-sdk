...
public:
	...
	/**
	* Make outgoing call to the specified URI. ----- QOS
	*
	...
	*                      request.
	*/
	void makeCallQOS(const string &dst_uri, const CallOpParam &prm, a_settings * settings, void* BadSipConnection) throw(Error);
	...
	void answerQOS(const CallOpParam &prm, a_settings * settings) throw(Error);
	/*
	*Some custom QOS added - Ognjen - overload - SWIG considerations
	*
	*/
	void answerQOS(const CallOpParam &prm,
